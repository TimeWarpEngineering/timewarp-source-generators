...
## Description
The TW0001 file naming analyzer is incorrectly checking files in build output directories (obj/, bin/) which contain auto-generated build artifacts. The analyzer should skip validation for these directories as they are not user-written source code.
...
## Acceptance Criteria
- [ ] TW0001 analyzer skips files in `/obj/` directories
- [ ] TW0001 analyzer skips files in `/bin/` directories
- [ ] TW0001 analyzer skips files in other common build output directories
...
## Technical Details
The fix should be implemented in the TW0001 analyzer by:
...
The fix should be applied in the TW0001 analyzer implementation, likely in the method that determines whether to analyze a given file.
